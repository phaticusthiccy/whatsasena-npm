...
async function worktype(type, Language) {
  ...
  if (type == 'private') {
    if (Language == 'TR') {
      data = "*WhatsAsena Private Olarak Çalışıyor! 🐺*\n\n" +
